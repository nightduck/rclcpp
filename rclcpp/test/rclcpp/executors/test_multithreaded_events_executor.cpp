...
TEST_F(TestEventsExecutor, run_pub_sub)
{
  ...
  MultithreadedEventsExecutor executor(4);
...
TEST_F(TestEventsExecutor, destroy_entities)
{
  ...
  MultithreadedEventsExecutor executor_pub(4);
  ...
  MultithreadedEventsExecutor executor_sub(4);
...
TEST_F(TestEventsExecutor, test_default_incompatible_qos_callbacks)
{
  ...
  MultithreadedEventsExecutor ex(4);
